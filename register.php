                ...
                <div class="card-body">
                    <form action="functions/authcode.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text"  name="name" class="form-control" placeholder="First name and Last name">
                        </div>
                        <div class="mb-3">
                        <label class="form-label">Phone</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" placeholder="Amir@email.Com" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
